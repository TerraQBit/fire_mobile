            ...
            child: Container(
                decoration: const BoxDecoration(
                  image: DecorationImage(
                      image: AssetImage("assets/onboarding2_back.png"),
                      fit: BoxFit.fill
                  ),
                ),
                child: Center(
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text('369 metres', style: GoogleFonts.overpassMono(fontSize: 12, color: Colors.white)),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(
                                height: 20,
                                child: Text('2/3', style: GoogleFonts.overpassMono(fontSize: 18, color: Colors.white)),
                              ),
                              GestureDetector(
                                  onTap: () {
